...
#' @description This function computes the sample size required for two arms clinical trials with continuous outcome measure. Four hypothesis tests are available under two allocation designs.
...
#' @rdname getSizeProp
#' @title General Formulas for Sample Size Calculation
#' @description This function computes the sample size required for two arms clinical trials with binary outcome measure. Four hypothesis tests are available under two allocation designs.
#' @param design allocation method (`parallel` or `crossover`).
#' @param test four hypothesis tests: `equality`, `noninferiority`, `superiority`, and `equivalence`.
#' @param alpha level of significance.
#' @param beta type II error.
...
#' @rdname getSizeTTE
#' @title General Formulas for Sample Size Calculation
#' @description This function computes the sample size required for two arms clinical trials with TTE outcome measure. Four hypothesis tests are available under two allocation designs.
#' @param design allocation method (`parallel` or `crossover`).
#' @param test four hypothesis tests: `equality`, `noninferiority`, `superiority`, and `equivalence`.
#' @param alpha level of significance.
#' @param beta type II error.
...
#' @rdname getSizeOrd
#' @title General Formulas for Sample Size Calculation
#' @description This function computes the sample size required for two arms clinical trials with ordinal outcome measure. Four hypothesis tests are available under two allocation designs.
#' @param design allocation method (`parallel` or `crossover`).
#' @param test four hypothesis tests: `equality`, `noninferiority`, `superiority`, and `equivalence`.
#' @param alpha level of significance.
#' @param beta type II error.
